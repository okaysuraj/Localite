...
export default function CreateEventLocationPickerScreen() {
  ...
  const venues = [
    { id: 1, name: 'The Gilded Library', match: '94% MATCH', desc: 'Quiet • Coworking • Mayfair', img: 'https://via.placeholder.com/300' },
    { id: 2, name: 'Atlas Botanica', match: 'TOP RATED', desc: 'Lively • Coffee • Soho', img: 'https://via.placeholder.com/300' },
    { id: 3, name: 'Vault No. 7', match: 'PRIVATE', desc: 'Mood • Jazz • Chelsea', img: 'https://via.placeholder.com/300' }
  ];
